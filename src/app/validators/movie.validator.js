...
const movieSchema = Joi.object({
  ...
  // poster_path
  poster_path: Joi.string().example("https://image.tmdb.org/t/p/w500/pB8BM7pdSp6B6Ih7QZ4DrQ3PmJK.jpg"),
  // year
  ...
  production_companies: Joi.array().items(Joi.string().example('20th Century Fox')),
